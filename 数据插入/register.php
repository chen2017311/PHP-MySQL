...
?>
	...
	<form class="form-horizontal" role="form" method="post" action="php/doregister.php"> <!--onSubmit="return pregMatch()">-->
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="password" class="form-control" id="inputPassword4" name="password2" placeholder="确认密码">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputEmail4" name="phone" placeholder="手机号">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <div class="checkbox">
            <label>
              <input type="checkbox" id="xieyi"> 阅读并接受
            </label>
